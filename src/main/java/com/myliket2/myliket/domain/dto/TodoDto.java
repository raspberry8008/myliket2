...
public class TodoDto {
    ...
    /*
     *  TodoDto.RequestInfo : 조회 요청한 할일 상세 정보
     *
    ...
    public static class RequestInsert extends TodoRequestVO {
        ...
        private LocalDateTime todoDateTime; // 할일 일정 및 시간
    ...
    /*
     *  TodoDto.RequestUpdate : 수정할 할일 상세 정보
     *
     *  String categoryId : 카테고리 아이디 (필수값 :TRUE)
     *  String todoTitle : 할일 제목 (필수값 :TRUE)
     *  String todoContent : 할일 내용 (필수값 :TRUE)
...
//        public LocalDateTime todoDateTimeMake ( LocalDate todoDay, LocalTime todoTime) {
//
//
