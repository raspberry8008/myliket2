...
public class TodoResponseDto extends TodoResponseVO {
    ...
    @Builder
    public TodoResponseDto(Long todoNo, String categoryId, String categoryName, String todoTitle, String todoContent, LocalDate todoDay, String todoTime, String todoState, String stateKor) {
        this.todoNo = todoNo;
    ...
    public TodoResponseDto(Long todoNo, String categoryId, String categoryName, String todoTitle, String todoContent, LocalDate todoDay, String todoTime) {
        this.todoNo = todoNo;
        this.categoryId = categoryId;
        this.categoryName = categoryName;
        this.todoTitle = todoTitle;
