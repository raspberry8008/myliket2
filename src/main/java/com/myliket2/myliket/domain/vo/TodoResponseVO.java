...
public class TodoResponseVO {
    ...
    @Builder
    public TodoResponseVO(Long todoNo, String categoryId, String categoryName, String todoTitle, String todoContent, LocalDate todoDay,
...
//    private LocalTime todoTimeNullCheck () {
//        LocalTime isTodoTime = todoTime;
//        if (Objects.isNull(isTodoTime)) {
